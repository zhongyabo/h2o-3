...
public class NaiveBayesV3 extends ModelBuilderSchema<NaiveBayes,NaiveBayesV3,NaiveBayesV3.NaiveBayesParametersV3> {
  ...
  /*Imbalanced Classes*/
    ...
    @API(help = "Seed for pseudo random number generator (only used for cross-validation and fold_assignment=\"Random\" or \"AUTO\") as string.", level = API.Level.expert, direction=API.Direction.OUTPUT, gridable = true)
