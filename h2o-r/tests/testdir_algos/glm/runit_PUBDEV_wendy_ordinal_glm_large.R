...
glmOrdinal <- function() {
 ...
 objR <- c(100*reg, 10*reg, reg, reg/10, reg/100,reg/1000, reg/10000, reg/100000, reg/1000000, reg/10000000)
 lambdaL <- c(0,100*reg, 10*reg, reg, reg/10, reg/100,reg/1000, reg/10000, reg/100000, reg/1000000)
