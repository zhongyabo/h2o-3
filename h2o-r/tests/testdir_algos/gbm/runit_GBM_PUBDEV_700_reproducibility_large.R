...
test.gbm <- function() {
  ...
  seeds = c(8568380275437571355, 6262970961823075204)
  trees = c(20, 30)
  csvFiles = c(locate('bigdata/laptop/jira/threshold_n8_20t_2d_s8568380275437571355.csv'),
...
TrainGBM <- function(data, model_id, seedNum, nTrees) {
  h2o.gbm(x=2:365, y='response', training_frame = data,
          ...
          model_id= model_id, score_tree_interval=nTrees, true_reproducibility=T
  )
}
